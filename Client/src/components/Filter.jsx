...
{/* filter by brand */}
      ...
      <div className='flex-col flex gap-2 mt-2'>
        ...
        <label htmlFor="">
            <input type="radio" checked={selectedStorage === "1"} onClick={()=>filterByStorage("1")} className='w-5 h-5' name='storage' /> {"64 GB"}
        </label>
        <label htmlFor="">
            <input type="radio" checked={selectedStorage === "2"} onClick={()=>filterByStorage("2")} className='w-5 h-5' name='storage' /> {"128 GB"}
        </label>
        <label htmlFor=""> 
            <input type="radio" checked={selectedStorage === "3"} onClick={()=>filterByStorage("3")} className='w-5 h-5' name='storage' /> {"256 GB"}
        </label>
        <label htmlFor="">
            <input type="radio" checked={selectedStorage === "4"} onClick={()=>filterByStorage("4")} className='w-5 h-5' name='storage' /> {"Above 256 GB"}
        </label>
